  ...
  fr_FR: {
    ...
    kbView: {
      ...
      imageEditor: {
        ...
        description:
          "Prend en charge le recadrage d'images, la rotation et l'optimisation automatique des fichiers numérisés",
        cancel: "Annuler",
      ...
      fusionCommand: {
        ...
        searchHelp:
          "↑↓ et Home, End pour sélectionner les résultats, ↵ pour aller à la sélection, ⌘+↵ pour insérer une référence de bloc, esc pour fermer le panneau de recherche",
        commandHelp:
          "Tapez / pour rechercher des commandes, ↑↓ et Home, End pour sélectionner une commande puis ↵ pour exécuter, esc pour fermer le panneau de commandes",
      },
      blockMover: {
      ...
      createNewTreeDialog: {
        ...
        waitingForSync:
          'En attente de synchronisation. Si vous êtes sûr que c\'est un nouveau document, cliquez sur "Créer" pour créer un nouveau document.',
        waitBtn: "Attendre",
        createBtn: "Créer",
      ...
      pasteDialog: {
        title: "Non Non",
        description:
          "Trop grand ! Ça va casser si vous le mettez dedans ! Essayez de coller par morceaux ?",
        cancelBtn: "J'ai compris",
      },
      attachmentsManager: {
        title: "Gestionnaire de pièces jointes",
        description: "Gérer tous vos fichiers joints",
        upload: "Téléverser",
        ...
        fetchFilesStatus: {
          ...
          success: "Liste des fichiers récupérée avec succès",
          failed: "Échec de la récupération de la liste des fichiers",
        },
        actions: {
          rename: "Rename",
          copy: "Copy",
      ...
      dailynoteNavigator: {
        ...
        dontKnowWhereToCreate: {
          title: "Ne sait pas où créer les notes quotidiennes",
          desc: 'Vous devriez aller dans "Paramètres > Notes quotidiennes > Emplacement des notes quotidiennes" pour définir où les nouvelles notes quotidiennes doivent être créées',
        },
      },
      history: {
