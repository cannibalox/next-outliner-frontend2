<template>
  <div class="flex flex-col gap-2">
    <div class="relative">
      <div class="relative max-w-[80vw] max-h-[50vh] overflow-auto">
        <div
          ref="containerRef"
          class="cursor-move"
          :style="{
...
import type { ViewingAnimateImageAttachment } from "@/context/attachmentViewer";
...
const props = defineProps<{
  viewingAttachment: ViewingAnimateImageAttachment;
}>();
