...
// import { blockEditor, type BlockPos } from "./blockEditor";
// import { z } from "zod";
...
// export const importer = defineModule(
//   "importer",
//   {blocksManager, blockEditor},
//   ({blocksManager, blockEditor}) => {

//     const parseV1Backup = (text: string) => {
...
//     const importBlocks = (blocks: AddBlockParams[]) => {
//       const linkBlocks = [];
